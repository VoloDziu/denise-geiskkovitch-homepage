      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            ...
            <MobileNavItem href="/students">Future Grad Students</MobileNavItem>
  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-px bg-linear-to-r from-purple-500/0 via-purple-500/40 to-purple-500/0 dark:from-purple-400/0 dark:via-purple-400/40 dark:to-purple-400/0" />
        )}
      </Link>
    </li>
  )
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 ring-1 shadow-lg shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        ...
        <NavItem href="/files/resume.pdf">CV</NavItem>
        <NavItem href="https://scholar.google.com/citations?hl=en&user=-occ9nIAAAAJ">
          Publications
        </NavItem>
        <NavItem href="/students">Future&nbsp;Grad&nbsp;Students</NavItem>
...
function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <MoonIcon className="hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition dark:block [@media_not_(prefers-color-scheme:dark)]:fill-purple-400/10 [@media_not_(prefers-color-scheme:dark)]:stroke-purple-500 [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400" />
    </button>
  )
}
